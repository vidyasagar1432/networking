...
- **Queues and Buffers** — Queues are logical constructs that hold packets during processing. Buffers are the physical RAM backing the queues.
- **FIFO** — Without QoS, all packets share a single FIFO queue with no differentiation.
