...
- **Priority queues** — WRED is not applied to LLQ priority classes because real-time traffic (voice/video) does not use TCP retransmission.
- **CBWFQ classes** — WRED is applied to CBWFQ classes and class-default to manage TCP-based data traffic.
